 ...
 */
public class AppPushMessageConfigStorage implements MessageConfigStorage {
     private String uri;
     private String key;
     ...
     * @param messageType
     */
    public AppPushMessageConfigStorage(String uri, String key, String masterSecret, MessageType messageType) {
        this.uri = uri;
        this.key = key;
        this.masterSecret = masterSecret;
        this.messageType = messageType;
    ...
    public AppPushMessageConfigStorage() {
    }
}
